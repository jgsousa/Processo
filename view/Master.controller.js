...
sap.sousa.Processo.util.Controller.extend("sap.sousa.Processo.view.Master", {
	...
	onRouteMatched : function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "sap.sousa.Processo.view.Detail",
			targetViewType : "XML"
		});
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("ProcessoID", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
